            ...
            success: function (req) {
              if(req.code == 999999){
                ...
                for (let data of req.postList) {
                 ...
                 <li>
                            <div class="itemList">
                                <a href="/communityUserDetail/${data.post.id}" target="_self">
                                    <div class="title">
                                        <p class="postsTit">${data.post.communityTitle}</p>
                                    </div>
                                    <p class="msg">
                                        <span class="lastReply">${formatDate(data.post.communityCre)}</span>
                                        <span class="number">
                                            ...
                                            <span class="reply_num">${data.likeCount}</span>
                                        </span>
                                            <span class="num reply">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                $('.searchListBox .searchNum span').text('0')
                $('.newsPagination').hide()
               setTimeout(() => {
